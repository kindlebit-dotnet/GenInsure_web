...
namespace InsuranceClaim.Controllers
{
    public class ClaimAdjustmentController : Controller
    {
        ...
        public ActionResult ListClaimAdjustment(DateTime? FromDate, DateTime? EndDate)
        {
            ...
            {
                var listdata = ListClaimAdjust.Where(m => m.CreatedOn >= FromDate && m.CreatedOn <= EndDate);
        ...
        //public ActionResult SearchclaimPolicy(DateTime? FromDate, DateTime? EndDate)
        //{
        //    var ListClaimAdjust = InsuranceContext.ClaimAdjustments.All(where: $"IsActive = 'True' or IsActive is null").OrderByDescending(x => x.Id);
        //    var listdata = ListClaimAdjust.Where(m => m.CreatedOn >= FromDate && m.CreatedOn <= EndDate);
        //   return View(listdata);
