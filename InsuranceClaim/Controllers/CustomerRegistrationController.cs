...
namespace InsuranceClaim.Controllers
{
    ...
    public class CustomerRegistrationController : Controller
    {
        ...
        [Authorize(Roles = "Staff,Administrator,Team Leaders,Agent,ALMSupport")]
        public ActionResult Index(int id = 0)
        {
            ...
            if (userLoggedin && id == 0)
            {
                ...
                if ((role != null && (role != "Staff" && role != "Renewals" && role != "Team Leaders") && role != "Agent" && role != "ALMSupport"))
                {
        ...
        public async Task<JsonResult> SaveCustomerData(CustomerModel model, string buttonUpdate)
        {
            if (ModelState.IsValid)
            {
                ...
                if (userLoggedin)
                {
                    ...
                    if (User.IsInRole("Staff") || User.IsInRole("Renewals") || User.IsInRole("Team Leaders") || User.IsInRole("Agent") || User.IsInRole("ALMSupport"))
                    {
        ...
        public ActionResult ProductDetail()
        {
            ...
            {
                if (User.IsInRole("Staff") || User.IsInRole("Team Leaders") || User.IsInRole("Agent") || User.IsInRole("ALMSupport"))
                {
        ...
        public ActionResult SummaryDetail(int summaryDetailId = 0, string paymentError = "")
        {
            ...
            try
            {
                ...
                //default selection 
                if (User.IsInRole("Staff") || User.IsInRole("Renewals") || User.IsInRole("Agent") || User.IsInRole("ALMSupport"))
                {
        ...
        public async Task<ActionResult> SubmitPlan(SummaryDetailModel model, string btnSendQuatation = "")
        {
            ...
            var id = "";
            var RandomUnique = Randomcode(id);
            try
            {
                if (model != null)
                {
                    ...
                    if (ModelState.IsValid)
                    {
                        ...
                        if (summaryDetial != null && btnSendQuatation == "") // while user come from qutation email
                        {
                            if (model.CustomSumarryDetilId != 0 && btnSendQuatation == "") // cehck if request is comming from agent email
                            {
                                ...
                                if (model.PaymentMethodId == 1 || model.PaymentMethodId == (int)paymentMethod.PayLater || model.PaymentMethodId == 4 || model.PaymentMethodId == 7)
                                    return RedirectToAction("SaveDetailList", "Paypal", new { id = model.CustomSumarryDetilId, invoiceNumber = model.InvoiceNumber, Paymentid = model.PaymentMethodId });
                        ...
                        if (role == "Staff" || role == "Team Leaders" || role == "Administrator" || role == "Agent" || role == "ALMSupport")
                        {
                        ...
                        if (vehicle != null && vehicle.Count > 0)
                        {
                            foreach (var item in vehicle.ToList())
                            {
                                ...
                                else
                                {
                                    ...
                                    //02_june_2022
                                    Vehicledata.UniqueCode = RandomUnique;
                                    vehicelDetails.UniqueCode = "";
                        ...
                        if (!string.IsNullOrEmpty(btnSendQuatation))
                        {
                            ...
                            foreach (var item in ListOfVehicles)
                            {
                                ...
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Cover Note # </font> </td> <td width='100'  style='padding: 1px 10px;'> <font size='1'>" + item.CoverNote + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px; '> <font size='1'> Transaction Date </font> </td> <td width='100' style='padding: 1px 10px; '> <font size='1'>" + item.TransactionDate.Value.ToString("dd/MM/yyyy") + " </font> </td> </tr>";
                                Summeryofcover += " </table>";

                                Summeryofcover += "<table  border='0' cellspacing='0' cellpadding='0' style='border-collapse:collapse; width:900px;' >";
                                ...
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Insurance Type </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>Road Traffic Act </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Vehicle Type </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + (item.CoverTypeId == 4 ? eCoverType.Comprehensive.ToString() : eCoverType.ThirdParty.ToString()) + " " + InsuranceContext.VehicleUsages.All(Convert.ToString(item.VehicleUsage)).Select(x => x.VehUsage).FirstOrDefault() + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Start Date </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.CoverStartDate.Value.ToString("dd/MM/yyyy") + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> End Date </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.CoverEndDate.Value.ToString("dd/MM/yyyy") + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'>Policy Period </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + paymentTermsNmae + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Premium </font> </td> <td width='100'  style='padding: 1px 10px;'> <font size='1'>" + item.Premium + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Gvt Levy </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.ZTSCLevy + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Stamp Duty </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.StampDuty + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Stamp Duty </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.UniqueCode + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Premium Due </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + Math.Round(Convert.ToDecimal(premiumDue), 2) + " </font> </td> </tr>";
                                Summeryofcover += " </table>";
                                ...
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Vehicle Reg. Number </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.RegistrationNo + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Vehicle Type </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + productDetail.ProductName + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Tax Class </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + taxClassDetials.Description + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px; font-size:15px;'> <font size='1'> Sum Insured </font> </td> <td width='100' style='padding: 1px 10px;'> <font size='1'>" + item.SumInsured + " </font> </td> </tr>";
                                Summeryofcover += "<tr> <td width='100' style='padding: 1px 10px;'> <font size='1'> Vehicle: </font> </td> <td width='100' style='padding: 5px 10px;'> <font size='1'>" + vehicledescription + " </font> </td> </tr>";
                                Summeryofcover += " </table> ";
                            ...
                            var Bodyy = MotorBody.Replace("##PolicyNo##", policyQuotation.PolicyNumber)
                                  .Replace("##TransactionDate##", vehicleQuotation.TransactionDate.Value.ToString("dd/MM/yyyy"))
                            ...
                            string Recieptbody = "Hi " + customer.FirstName + "\nYour quote for " + vehicleQuotation.RegistrationNo + " " + converType + " Insurance with GeneInsure is " + "$" + Convert.ToString(summaryDetail.TotalPremium) + ". You can pay via Swipe or Ecocash *151*2*2*249341*AMOUNT#. Thank you.";
        ...
        public string Randomcode(string methoid)
        {
            Random rnd = new Random();
            string myRandomNo = Convert.ToString(rnd.Next(1000000, 9999999));
            return myRandomNo;
        }
        ...
        public JsonResult getPolicyDetailsFromICEcash(string regNo, string PaymentTerm, string SumInsured, string make, string model, string VehicleYear, int CoverTypeId, int VehicleType, string CoverStartDate, string CoverEndDate, bool VehilceLicense, string taxClassId, bool RadioLicense, string licensePaymentTerm, string radioPaymentTerm, string VehicleValue)
        {
            ...
            try
            {
                ...
                if (patnerToken != "")
                {
                    ...
                    if (quoteresponse != null && quoteresponse.Response != null && (quoteresponse.Response.Message.Contains("Partner Token has expired") || quoteresponse.Response.Message.Contains("Invalid Partner Token")))
                    {
                        tokenObject = ICEcashService.getToken();
                        SummaryDetailService.UpdateToken(tokenObject);
                    ...
                    if (response.result == 0)
                    {
                        response.message = quoteresponse.Response.Quotes == null ? "" : quoteresponse.Response.Quotes[0].Message;
                    }
                    else
                    {
                        response.Data = quoteresponse;
                        if (quoteresponse.Response != null && quoteresponse.Response.Quotes != null && quoteresponse.Response.Quotes[0] != null)
                        {
                        ...
                        if (quoteresponse.Response.Quotes != null && quoteresponse.Response.Quotes[0] != null && quoteresponse.Response.Quotes[0].Policy != null)
                        {
                            string format = "yyyyMMdd";
                        ...
                        if (quoteresponse.Response.Quotes != null && quoteresponse.Response.Quotes[0] != null && quoteresponse.Response.Quotes[0].Licence != null)
                        {
        ...
        public JsonResult GetCustomerId()
        {
            ...
            string query = "select top 1* from UniqueCustomer order by id desc";

            var dbCustomer = InsuranceContext.Query(query).Select(x => new UniqueCustomer()
            {
        ...
        [Authorize(Roles = "Finance,ALMSupport")]
        ...
        //Get Customer details when searched by the invoice number in the Receipet Payment
        public JsonResult GetCustomername(string txtvalue)
        {
            ...
            int policyId = 0;
            var policyAndRegistrationNumber = txtvalue;
            ...
            if (vehicleDetail == null)
                ...
                currencyId = vehicleDetail.CurrencyId;


            var currencyDetail = InsuranceContext.Currencies.Single(currencyId);
        ...
        public JsonResult SendEmail(Int32 id)
        {
            ...
            objEmailService.SendEmail(user.Email, "", "", subject, Body2, attachements);
