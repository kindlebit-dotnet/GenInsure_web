...
namespace Insurance.Service
{
    public class ICEcashService
    {
        ...
        public ResultRootObject RequestQuote(string PartnerToken, string RegistrationNo, string suminsured, string make, string model, int PaymentTermId, int VehicleYear, int CoverTypeId, int VehicleUsage, string PartnerReference, DateTime CoverStartDate, DateTime CoverEndDate, string TaxClass, decimal VehicleValue)
        {
            ...
            if (json!=null && json.Response.Quotes != null && json.Response.Quotes.Count > 0)
            {
        ...
        public static ResultRootObject LICQuoteUpdate(Customer customer, VehicleDetail vehicleDetail, string PartnerToken, int? paymentMethod)
        {
            ...
            qut.Add(new LicQuoteDetial { LicenceID = item.LicenseId, Status = "1", DeliveryMethod = "3", LicenceCert = 1, MachineName = Environment.MachineName });
        ...
        public static ResultLicenceIDRootObject LICResult(string LicenceID, string PartnerToken)
        {
            string _json = "";
            ...
            SummaryDetailService.WriteLog(data, response.Content, "LICResult");
